...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.88\linewidth,height=0.8\textheight,keepaspectratio,angle=90]{Imagenes/diagrama_actividades_sesion.png}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.95\linewidth,height=0.8\textheight,keepaspectratio]{Imagenes/diagrama_secuencia_principal.png}
