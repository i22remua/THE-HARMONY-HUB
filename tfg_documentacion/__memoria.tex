...
\usepackage[hidelinks,linktoc=all]{hyperref}%para el hiperlink de las secciones
...
% Lista de acrónimos. Descomenta este bloque si defines acrónimos en lista_acronimos.tex.
% \cleardoublepage
% \phantomsection
...
\input{4_analisis_problema}
\input{5_diseno_solucion}
\input{6_desarrollo_implementacion}
\input{7_pruebas_validacion}
...
\input{8_planificacion_recursos}

\input{9_conclusiones_y_trabajos_futuros}
