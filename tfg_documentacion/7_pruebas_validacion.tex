...
\small
\renewcommand{\arraystretch}{1.1}
\begin{tabularx}{\textwidth}{|P{1.2cm}|P{2.5cm}|P{2.2cm}|Y|P{2.6cm}|}
\hline
...
\small
\renewcommand{\arraystretch}{1.1}
\begin{tabularx}{\textwidth}{|P{1.0cm}|P{4.2cm}|Y|P{1.8cm}|}
\hline
...
las búsquedas externas entran en rate limit. En lugar de quedar bloqueado
...
suficiente a nivel global y también para el estado emocional concreto que se
pretende recomendar. Esto permitió alinear mejor el comportamiento del sistema
con una explicación académica más prudente y más fiel al estado real de los
datos.
...
\hline
\textbf{T2} & Estado real del conjunto supervisado & La colección \texttt{training\_session\_examples} alcanzó \texttt{65} ejemplos etiquetados, con balance \texttt{53} útiles frente a \texttt{12} no útiles. & Correcto \\
\hline
...
\hline
\textbf{T6} & Distinción entre capas de aprendizaje & La evidencia confirma que la madurez del perfil individual y la activación del clasificador global son procesos relacionados pero no idénticos: el primero estabiliza pesos y afinidades del usuario, mientras que el segundo aporta reordenación probabilística sobre candidatos de modo. & Correcto \\
\hline
\end{tabularx}
...
global no elimina la capa individual del usuario, donde siguen apareciendo
...
supervisado como componente integrado pero inactivo. El conjunto actual, con 65
