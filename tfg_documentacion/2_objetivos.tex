...
\begin{tabularx}{\textwidth}{|P{1.75cm}|P{4.55cm}|Y|}
\hline
...
\hline
OE6 & Persistencia del historial, recogida de feedback y activación controlada de aprendizaje progresivo. & Registro de sesiones y feedback, almacenamiento en base de datos, señales observables del aprendizaje individual del perfil y métricas objetivas del modelo de sesión, incluyendo puertas de datos, calidad y confianza operativa. \\
\hline
