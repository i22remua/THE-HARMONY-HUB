...
\subsection{seccion prueba}
asdf

\subsubsection{seccion prueba}
asdf
...
\begin{figure}[H]
  \centering
  % include first image
  \includegraphics[width=.8\linewidth]{Imagenes/logoUCO.pdf}  
...
En la Figura \ref{figT:subfiguras} se puede apreciar una figura compuesta por dos subfiguras.
...
Y con estos valores se calculan las coordenadas x e y:
